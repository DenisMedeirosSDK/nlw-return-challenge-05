    ...
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[384px]">
        ...
        <button
          ...
          className="py-2 px-4 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-100 bg-zinc-100 hover:bg-white dark:hover:bg-zinc-700 rounded-md border-transparent text-sm leading-6 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
        >
          Quero enviar outro
        </button>
      </div>
